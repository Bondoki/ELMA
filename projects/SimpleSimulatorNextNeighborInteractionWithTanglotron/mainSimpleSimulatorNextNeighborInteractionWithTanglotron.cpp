...
int main(int argc, char* argv[])
{
  try{
	...
	typedef LOKI_TYPELIST_4(FeatureMoleculesIO, FeatureAttributes, FeatureNNInteractionSc< FeatureLattice >, FeatureTanglotronSR) Features;

	typedef ConfigureSystem<VectorInt3,Features, 6> Config;
	typedef Ingredients<Config> Ing;
	Ing myIngredients;

	// calculate the Tanglotron-potential
	myIngredients.setCalculatePotential(true);
