 ...
 * @file
 *
 * @class UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction
 *
...
class UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction: public UpdaterAbstractCreate<IngredientsType>
{
...
public:
	 ...
	 */
	UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction(IngredientsType& ing
	,uint32_t steps
...
// constructor
template<class IngredientsType,class MoveType>
UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::
UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction(IngredientsType& ing,
				uint32_t steps, 
				uint32_t stepsBeforeBiasCheck,
...
//execute simulation
template<class IngredientsType, class MoveType>
bool UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::execute()
{
	...
	for(int n=0;n<nsteps;n++){
		...
		try{
			...
			errormessage<<"UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction: error while altering histogram.\n"
...
template<class IngredientsType, class MoveType>
void UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::initialize()
{
	std::stringstream ssprefixWindow;
	ssprefixWindow << "_idxWin" << std::setw(2) << std::setfill('0') << numberIdxWindow;
	prefixWindow = ssprefixWindow.str();
...
template<class IngredientsType, class MoveType>
void UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::resetHistogram()
{
...
template<class IngredientsType, class MoveType>
void UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::shiftHGLnDOS()
{
...
//returns true
template<class IngredientsType, class MoveType>
bool UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::histogramConverged()
{
...
template<class IngredientsType, class MoveType>
bool UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::distributionCheck()
{
	...
	{
		std::cerr<<"WARNING: UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction finds NaN or inf in convergence check in mcs "
		<<ingredients.getMolecules().getAge()<<"\n";
		return false;
	}
...
//last two checks. 
template<class IngredientsType, class MoveType>
bool UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::flatnessCheck()
{
...
template<class IngredientsType, class MoveType>
double UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::histogramFlattness()const
{
...
template<class IngredientsType, class MoveType>
void UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::updateModificationFactor()
{
...
template<class IngredientsType,class MoveType>
void UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::dumpHistogram(std::string filename)
{
...
//write current histogram to file
template<class IngredientsType,class MoveType>
void UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::dumpTotalHistogram(std::string filename)
{
...
template<class IngredientsType,class MoveType>
void UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::dumpHGLnDOS(std::string prefix, double _min, double _max)
{
	std::stringstream filename;
...
template<class IngredientsType,class MoveType>
void UpdaterAdaptiveWangLandauSamplingExtendedShellInteraction<IngredientsType,MoveType>::dumpConvergenceProgress()
{
	std::stringstream filename;
