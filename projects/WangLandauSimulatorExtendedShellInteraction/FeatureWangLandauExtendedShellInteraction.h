 ...
 **/
template<template<typename> class LatticeClassType>
void FeatureWangLandauExtendedShellInteraction<LatticeClassType>::setNNInteraction(int32_t typeA,
								     int32_t typeB,
								     double energy)
{
	...
	std::cout<<typeA<<" and "<<typeB<<" to "<<energy<<"kT\n";
      ...
      {
	std::stringstream errormessage;
	errormessage<<"FeatureWangLandauExtendedShellInteractionFeatureNNInteractionSc::setNNInteraction(typeA,typeB,energy).\n";
 ...
 **/
template<template<typename> class LatticeClassType>
double FeatureWangLandauExtendedShellInteraction<LatticeClassType>::getNNInteraction(int32_t typeA,
								       int32_t typeB) const
{
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
double FeatureWangLandauExtendedShellInteraction<LatticeClassType>::getInternalEnergy(const IngredientsType& ingredients,size_t index, VectorInt3 direction) const
{
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
double  FeatureWangLandauExtendedShellInteraction<LatticeClassType>::getInternalEnergyDifference(const IngredientsType& ingredients,size_t index,VectorInt3 direction) const
{
	std::vector<VectorInt3> contactSites;
